...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    public void onCreate( SQLiteDatabase db ) {
        ...
        sqlCreate += " integer primary key autoincrement, " + FIRSTNAME + " text, " + LASTNAME + " text, " + EMAIL + " text )";
    ...
    public void insert( Friend friend ) {
        ...
        sqlInsert += " values( null, '" + friend.getFirstname( ) + "', '" + friend.getLastname( ) + "', '" + friend.getEmail( ) + "' )";
